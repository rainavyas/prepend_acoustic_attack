...
def attack_args():
    ...
    commandLineParser.add_argument('--attack_command', type=str, default='mute', choices=['mute', 'hallucinate', 'translate'], help='Objective of attack - hidden universal command/control.')
